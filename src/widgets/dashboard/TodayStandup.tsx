...
import styles from "./TodayStandup.module.scss";
    ...
    <div className={styles.card}>
      <div className={styles.header}>
        ...
        <div className={styles.actions}>
          {standup && !editing && (
            <>
              <button
                className={`btn btn-ghost btn-xs ${styles.actionBtn}`}
                onClick={handleEdit}
              >
                <MdEdit size={13} /> Edit
              </button>
      ...
      {!standup ? (
        <div className={styles.noStandup}>
          <div className={styles.noStandupText}>
            No standup generated yet for today.
          </div>
          <button
            ...
            <div key={field} className={styles.editField}>
              ...
              <textarea
                ...
                placeholder={
                  field === "blockers"
                    ? "None"
                    : `What did you ${field === "yesterday" ? "do yesterday" : "plan today"}?`
                }
              />
            </div>
          ))}
        ...
        <div className={styles.sections}>
          {[
            ...
            { label: "Today", value: standup.today, color: "var(--accent)" },
            {
              ...
              color: standup.blockers ? "var(--red)" : "var(--text-3)",
            },
          ].map(({ label, value, color }) => (
            <div key={label} className={styles.section}>
              <div className={styles.sectionLabel} style={{ color }}>
                {label}
              </div>
