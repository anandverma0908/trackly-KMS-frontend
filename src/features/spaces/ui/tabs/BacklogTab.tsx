...
import type { Project, ProjectTask, ProjectSprint } from "../../model/spacesData";
import { getPriorityColor, getTaskStatusColor } from "../../model/spacesData";
...
import styles from "./BacklogTab.module.scss";
